...
│ ├── Pivot Analysis - Aggregated country comparisons
...
- Type: Structured dataset (Numerical + Categorical)  
...
- Identifying high TB burden countries  
- Comparing incidence and mortality rates across regions  
- Evaluating treatment success patterns  
- Understanding regional disparities  
- Building dashboards for quick interpretation of global patterns  
...
- Country-wise TB incidence comparison  
- Regional summaries  
- Mortality vs treatment success evaluation  
- Aggregated statistics for quick benchmarking  
